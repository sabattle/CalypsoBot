...
module.exports = (client) => {
  ...
  db.prepare('CREATE TABLE IF NOT EXISTS config (guildID TEXT PRIMARY KEY, defaultChannelID TEXT, memberRole TEXT, modRole TEXT, crownRole TEXT);').run();
  ...
  client.setRow = db.prepare('INSERT OR REPLACE INTO config (guildID, defaultChannelID, memberRole, modRole, crownRole) VALUES (@guildID, @defaultChannelID, @memberRole, @modRole, @crownRole);');
