...
const guildSettings = {
  ...
  selectPointsEnabled: db.prepare('SELECT points_enabled FROM guild_settings WHERE guild_id = ?;'),
  updatePointsEnabled: db.prepare('UPDATE guild_settings SET points_enabled = ? WHERE guild_id = ?;'),
