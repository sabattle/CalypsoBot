...
db.prepare(`
  CREATE TABLE IF NOT EXISTS guild_settings (
    ...
    auto_role_id TEXT,
    crown_role_id TEXT,
    enable_points INTEGER NOT NULL,
...
const guildSettings = {
  ...
  selectEnablePoints: db.prepare('SELECT enable_points FROM guild_settings WHERE guild_id = ?;'),
  updateEnablePoints: db.prepare('UPDATE guild_settings SET enable_points = ? WHERE guild_id = ?;'),
