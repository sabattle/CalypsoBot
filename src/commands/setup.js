...
module.exports = {
  ...
  run: (message) => {
    if (message.member.hasPermission('ADMINISTRATOR')){
      ...
      message.channel.send('First, please enter the ID of your **Welcome** channel. Welcome messages and stream alerts will be sent here. If you do not have one, please type **none**.');
