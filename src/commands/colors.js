module.exports = {
  ...
  run: (message) => {
    ...
    if (colors.size === 0) return message.channel.send('There are currently no colors on this server. They can be set up by creating roles beginning with **#** that have specific colors. These roles should be towards the bottom of the role hierarchy.');
